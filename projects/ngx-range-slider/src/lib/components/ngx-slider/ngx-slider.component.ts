...
import {CustomStepDefinition, LabelType, Options, PositionToValueFunction, ValueToPositionFunction} from '../../configs/options';
import {ChangeContext} from '../../configs/change-context';
import {PointerType} from '../../configs/pointer-type';
